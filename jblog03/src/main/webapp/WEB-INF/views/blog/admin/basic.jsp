		...
		<div id="wrapper">
			<div id="content" class="full-screen">
				<ul class="admin-menu">
					...
					<li><a href="${pageContext.request.contextPath}/${resquestScope.id }/admin/catergory">카테고리</a></li>
					<li><a href="${pageContext.request.contextPath}/${resquestScope.id }/admin/write">글작성</a></li>
				</ul>
